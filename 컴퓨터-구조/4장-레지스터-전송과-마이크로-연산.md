...
- 레지스터전송언어
  - 마이크로연산, 전송을 간단하고 명료하게 표시하기 위해 사용하는 기호
  - 디지털 컴퓨터의 내부 조직을 상세하게 나타내는 수단으로 사용
  - 디지털 시스템의 설계 편의성 제공

- 레지스터 전송 언어 규칙
  - 대문자로 표시
  - 레지스터 가장 왼쪽 FF → MSB(Most Significant Bit),  가장 오른쪽 → LSB(Least Significant Bit)
  - 16비트 PC 레지스터의 경우
    - 상위(8~15) : PC(H)
    - 하위(0~7) : PC(L)
...
- 3-상태 버터 (3-state Buffer)
  - 멀티플렉서 대신 사용해 버스 구성 가능
  - 3개의 상태로 종작
...
- 산술 마이크로 연산
  ...
  ![산술 마이크로 연산](4장-레지스터-전송과-마이크로-연산.assets/arithmetic-microoperations-l-e1543421805755-16558137502742-16558149530217.jpg)
...
![논리 마이크로 연산](4장-레지스터-전송과-마이크로-연산.assets/img-16558149000506.png)
